                    ...
                    <table class="table">
                        ...
                        <tr class="user-row customTableStyling" data-position="" data-role="" onclick="">
                            ...
                            <td class="editDelete">
                                ...
                                <form method="post" action="{{ route('users.restore', $deletedUser->id) }}" style="display:inline;">
                                    @csrf
                                    <button type="submit"
                                ...
                                <form method="post" action="{{ route('users.forceDelete', $deletedUser->id) }}" style="display:inline;">
                                    @csrf
                                    @method('delete')
                                    <button type="submit"
