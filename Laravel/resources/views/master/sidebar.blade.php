<div class="sidebarContent">
    ...
    <div class="links">
        <div class="link dashboard {{ Request::routeIs('dashboard.*') ? 'selected' : '' }}" onclick="location.href='#'">
        ...
        <div class="link users {{ Request::routeIs('users.*') ? 'selected' : '' }}" onclick="location.href='{{ route('users.index') }}'">
        ...
        <div class="link material {{ Request::routeIs('materials.*') ? 'selected' : '' }}" onclick="location.href='{{ route('materials.index') }}'">
        ...
        <div class="link trainings {{ Request::routeIs('external.*') ? 'selected' : '' }}" onclick="location.href='{{ route('external.index') }}'">
        ...
        <div class="link clothing {{ Request::routeIs('clothing.*') ? 'selected' : '' }}" onclick="location.href='{{ route('clothing.index') }}'">
        ...
        <div class="link classes {{ Request::routeIs('course-classes.*') ? 'selected' : '' }}" onclick="location.href='{{ route('course-classes.index') }}'">
        ...
        <div class="link courses {{ Request::routeIs('courses.*') ? 'selected' : '' }}" onclick="location.href='{{ route('courses.index') }}'">
        ...
        @endif
        <div class="link tickets {{ Request::routeIs('tickets.*') ? 'selected' : '' }}" onclick="location.href='#'">
