<div class="sidebarContent">
    ...
    <div class="links">
        <div class="link tickets {{ Request::routeIs('tickets.*') ? 'selected' : '' }}" onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('tickets.index') }}'">
        ...
        @if (Auth::user()->hasRole('admin') || Auth::user()->hasRole('tecnico'))
            <div class="link dashboard {{ Request::routeIs('dashboard.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('dashboard.index') }}'">
            ...
            <div class="link users {{ Request::routeIs('users.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('users.index') }}'">
            ...
            <div class="link material {{ Request::routeIs('materials.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('materials.index') }}'">
            ...
            <div class="link trainings {{ Request::routeIs('external.*') ? 'selected' : '' }} {{ Request::routeIs('partners.*') ? 'selected' : '' }} {{ Request::routeIs('trainings.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('external.index') }}'">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                    <path fill="#116fdc"
            ...
            <div class="link classes {{ Request::routeIs('course-classes.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('course-classes.index') }}'">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                    <path fill="#116fdc"
            ...
            <div class="link clothing {{ Request::routeIs('material-user.*') ? 'selected' : '' }}" onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('material-user.index') }}'">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                    <path fill="#116fdc"
            ...
            <div class="link courses {{ Request::routeIs('courses.*') ? 'selected' : '' }}"
                onclick="const sidebar = document.querySelector('.sidebarContent'); sidebar.classList.remove('collapsedSidebar'); localStorage.setItem('sidebarState', 'expanded'); location.href='{{ route('courses.index') }}'">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 448 512">
                    <path fill="#116fdc"
