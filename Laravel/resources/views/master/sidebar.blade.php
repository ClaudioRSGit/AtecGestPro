<div class="sidebarContent">
    ...
    <div class="links">
        <div class="link tickets {{ Request::routeIs('tickets.*') ? 'selected' : '' }}" onclick="location.href='{{ route('tickets.index') }}'">
        ...
        @if (Auth::user()->hasRole('admin') || Auth::user()->hasRole('tecnico'))
            ...
            <div class="link clothing {{ Request::routeIs('material-user.*') ? 'selected' : '' }}" onclick="location.href='{{ route('material-user.index') }}'">
                <svg xmlns="http://www.w3.org/2000/svg" height="16" width="20" viewBox="0 0 640 512">
                    <path fill="#116fdc"
