        ...
        @if ($partner_Training_Users)
            <div class="grid">
                ...
                <div class="training">
                    ...
                    <input class="form-control {{ optional($partner_Training_Users->training)->name ? '' : 'text-danger' }}"
                        value="{{ optional($partner_Training_Users->training)->name ?? 'Esta formação foi eliminada.' }}"
                        disabled>
                </div>
                <div class="partner">
                ...
                <div class="technician">
                    ...
                    <input class="form-control {{ optional($partner_Training_Users->user)->name ? '' : 'text-danger' }}"
                        value="{{ optional($partner_Training_Users->user)->name ?? 'O técnico foi eliminado' }}" disabled>
                </div>
                <div class="address">
                    <label scope="row">Morada do Parceiro</label><br>
                    <input
                        class="form-control {{ optional($partner_Training_Users->partner)->address ? '' : 'text-danger' }}"
                        value="{{ optional($partner_Training_Users->partner)->address ?? 'O parceiro foi eliminado.' }}"
                        disabled>
                </div>
