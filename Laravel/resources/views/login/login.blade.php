...
<div class="container mx-auto d-flex align-items-center loginPage w-100 fade-in">
    <div class="d-flex justify-content-center w-100 ">
        <div class="card" style="border-radius: 2rem; min-width: 50%;">
                <div class="d-flex flex-column justify-content-between align-items-center h-100 w-100" style="min-height: 70%; padding: 5rem;">
